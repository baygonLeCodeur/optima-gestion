...
export function BuyPageFilter({ onFilterChange, onReset }: BuyPageFilterProps) {
  // --- STATE MANAGEMENT ---
  ...
  const handleFilterChange = (filterType: keyof FilterState, value: string) => {
    setFilters(prev => {
      ...
      // Reset dependent filters and their data when a parent filter changes
  ...
  const handleReset = () => {
    ...
    setPropertyTypesData(null); // Refetch initial data if needed, or just clear
    setCitiesData(null);
    setAddressesData(null);
    setPricesData(null);
    fetchPropertyTypes(); // Refetch property types on reset
    onReset();
  };
