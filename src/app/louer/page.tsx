...
import { RentPageFilter } from '@/components/RentPageFilter'; // MODIFIÉ
...
const mapPropertyData = (property: any): PropertyCardType & { 
  ...
  const statusText = 'À Louer'; // MODIFIÉ
...
export default function RentPage() { // MODIFIÉ
      ...
      <main className="flex-grow py-12 md:py-24 bg-secondary">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-12 font-headline">
            Biens disponibles à la location {/* MODIFIÉ */}
          </h1>
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="lg:w-1/4">
              <RentPageFilter  // MODIFIÉ
